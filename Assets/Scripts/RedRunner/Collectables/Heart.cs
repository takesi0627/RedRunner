...
namespace RedRunner.Collectables
{
	...
	public class Heart : Collectable
	{
		...
		public delegate void HeartCollectHandler (Heart heart);

		public static event HeartCollectHandler OnHeartCollected;
		...
		public override void Collect ()
		{
			...
			// AudioManager.Singleton.PlayHeartSound (transform.position);
		}
